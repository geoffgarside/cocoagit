...
static const NSUInteger kGITPackIndexFanOutEnd   = 4 * 256;    //!< Update when
                                                               // either of the
                                                               // two above
                                                               // change
...
- (NSArray *)loadOffsetsWithError: (NSError**)error {
    ...
    for ( i = 0; i < kGITPackIndexFanOutCount; i++ ) {
        [self.data getBytes: &value range: NSMakeRange(i * kGITPackIndexFanOutSize,
                                                       kGITPackIndexFanOutSize)];
