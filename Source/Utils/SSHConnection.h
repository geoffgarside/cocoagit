// SSHConnection
// Adrian Sampson
// A lightweight Objective-C wrapper for libssh2. For now only supports scp
// transfers
// and SFTP deletes.
...
#define SSHCONNECTION_ERROR_NOSESSION     4917 // tried to write data while not
                                               // connected
...
- (NSError *)connectToHost: (NSString *)host port: (unsigned short)port user: (NSString *)user
password: (NSString *)password;
- (NSError *)connectToHost: (NSString *)host user: (NSString *)user password: (NSString *)password; //
                                                                                                    // port
                                                                                                    // 22
- (void)disconnect;
